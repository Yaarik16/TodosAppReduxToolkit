...
import {increment, decrement, incrementByAmount, incrementByAmountAsync} from "../../state/counter/counterSlice.ts";
...
const Counter = () => {
    ...
    return (
        <div>
            ...
            <button onClick={() => dispatch(incrementByAmountAsync(20))}>Increment by 20 async</button>
        </div>
    )
}
